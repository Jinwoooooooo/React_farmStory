          ...
          <form onSubmit={submitHandler} method="post">
            <table border="0">
              <tr>
                <td>상품명</td>
                <td>
                  <input type="text" name="productName" value={product.productName} onChange={changeHandler} />
                </td>
              </tr>
              <tr>
                <td>종류</td>
              ...
              <tr>
                ...
                <td>
                  <label>
                    <input type="radio" name="delivery" value={"2000"} onChange={changeHandler} />
                    2,000원
                  </label>
                  <label>
                    <input type="radio" name="delivery" value={"3000"} onChange={changeHandler} />
                    3,000원
                  </label>
                  <label>
                    <input type="radio" name="delivery" value={"5000"} onChange={changeHandler} />
                    5,000원
                  </label>
                  <label>
                    <input type="radio" name="delivery" value={"0"} onChange={changeHandler} />
                    무료
                  </label>
                </td>
              </tr>
              <tr>
                <td>재고</td>
                <td>
                  <input type="text" name="stock" value={product.stock} onChange={changeHandler} />
                </td>
              </tr>
              <tr>
                <td>상품이미지</td>
